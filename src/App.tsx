          ...
          <div className="flex-1 relative overflow-hidden">
            ...
            >
              <div 
                ...
                className={`w-full h-full ${shouldBeFullWidth ? 'flex flex-col' : `overflow-y-auto px-4 sm:px-6 lg:px-8 pt-global ${isBottomNavHidden ? 'pb-[calc(1.2rem+env(safe-area-inset-bottom))]' : 'pb-[calc(76px+env(safe-area-inset-bottom)+16px)]'}`}`}
              >
                {renderView()}
              </div>
            </div>

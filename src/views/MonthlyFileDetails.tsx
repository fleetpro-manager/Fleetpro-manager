...
const AvailableBalancePage = ({ 
  ...
  return createPortal(
    ...
    >
      ...
      >
        <div className="flex-1 overflow-y-auto pt-4 px-4 space-y-4 pb-[180px] font-sans">
        ...
        {selectedCategory && (
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto pt-6 px-4 space-y-4 pb-[140px] safe-bottom">
  ...
  return createPortal(
    ...
    >
      ...
      <div 
        className="flex-1 flex flex-col overflow-hidden"
      >
        <div className="flex-1 overflow-y-auto pt-4 px-4 space-y-4 pb-[180px]">
      ...
      {selectedTrip && selectedTrip.category !== 'EXTRA_FUEL' && createPortal(
        ...
        >
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-4 pt-8 space-y-6 pb-[140px] md:pb-6">

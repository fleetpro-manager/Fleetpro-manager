  ...
  return (
    ...
    >
      {!activeSection ? (
        <div 
          key="main-wallet"
          className="absolute inset-0 w-full h-full overflow-y-auto px-4 sm:px-6 lg:px-8 pt-6 pb-[calc(76px+env(safe-area-inset-bottom)+80px)] space-y-4"
        >
          ...
          >
            <div className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 pt-6 pb-28">
              <div className="tx-list">
          ...
          <div 
            ...
            style={{ background: (isNightMode || appThemeMode === 'dark' || isDarkMode) ? '#000000' : (wallpaper ? `url(${wallpaper}) center/cover no-repeat fixed` : (backgroundColor || 'var(--app-bg)')) }}
          >
            <div className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 pt-6 pb-[calc(76px+env(safe-area-inset-bottom)+40px)] space-y-6">
